...
describe "configuration methods" do
  ...
  describe "#default_per_page" do
    ...
    context "when configuring both on global and model-level" do
      before do
        Divination.configure {|c| c.default_per_page = 50 }
    ...
    context "when configuring multiple times" do
      before do
        Divination.configure {|c| c.default_per_page = 10 }
        Divination.configure {|c| c.default_per_page = 20 }
      end
    ...
    after do
      Divination.configure {|c| c.default_per_page = 25 }
  ...
  describe "#max_per_page" do
    ...
    context "when configuring both on global and model-level" do
      before do
        Divination.configure {|c| c.max_per_page = 50 }
    ...
    context "when configuring multiple times" do
      before do
        Divination.configure {|c| c.max_per_page = 10 }
        Divination.configure {|c| c.max_per_page = 20 }
      end
    ...
    after do
      Divination.configure {|c| c.max_per_page = nil }
